...
----------------------------
	# URL
		https://git.mrwang.pw/Reed/Linux_ssr_script/src/master/ssr
	...
	# 配置文件目录:
		/root/.local/share/shadowsocksr/config.json
...
BRANCH=manyuser
GIT_REPO=http://git.mrwang.pw/Reed/shadowsocksr-backup.git
