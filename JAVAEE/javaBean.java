...
PropertyDescriptor pds[] = info.getPropertyDescriptors();
	通过BeanInfo来获取javaBean里面的所有属性对象
PropertyDescriptor pd = new PropertyDescriptor("userName", User.class);
	通过构造方法指定javaBean,以及属性名.来获取单个属性的对象	


PropertyDescriptor//属性描述对象
	getName();//获取属性名称(userName)
	getPropertyType();//获取属性的类型(java.lang.String)
	getWriteMethod();//返回Method类,是写入属性的Mehtod,方法！
	getReadMethod();//返回Method类,是读取属性的Method,方法
